...
import PostDetail from './ShowPost/PostDetail'
const SearchPost = (props) => {
    const { queryPost: { id, sex, type, title, desc, likecount, favorite, msg, date }, handlePostDetail, handleFavorite, handleLike } = props
